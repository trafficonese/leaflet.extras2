...
addTimeslider <- function(map, data, radius = 10,
  ...
  datajson <- geojsonsf::sf_geojson(data)
  ...
  invokeMethod(map, data, "addTimeslider", datajson, options, popupOptions) %>%
...
#' @param showPopups Show popup, when marker is generated by the slider.
#'   Default is \code{FALSE}
#' @param showAllPopups Show all popups, instead of only one; same as the popup
#'   option \code{autoClose = FALSE}
#' @family Timeslider Functions
