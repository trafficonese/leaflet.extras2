...
#' @seealso \url{https://github.com/cscott530/leaflet-history}
#' @export
#' @examples
#' library(leaflet)
#' leaflet()  %>%
...
#' goBackHistory
#' If possible, will go to previous map extent. Pushes current to the "future" stack.
#' @param map a map widget object created from \code{\link[leaflet]{leafletProxy}}
#' @family History Functions
#' @seealso \url{https://github.com/cscott530/leaflet-history}
#' @export
#' @examples
...
#' goForwardHistory
#' If possible, will go to next map extent. Pushes current to the "back" stack.
