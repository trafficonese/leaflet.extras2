...
data <- structure(list(
  Name = structure(4L, levels = c("ALPHA", "ARLENE",
  ...
  geometry = structure(list(
    structure(c(-86.7, -87.2, -87.6, -87.9, -88.5, -89, -89.7,
                ...
                46.5, 48, 48.5, 48.5), dim = c(34L, 2L), class = c("XY","LINESTRING", "sfg"))),
    class = c("sfc_LINESTRING", "sfc"),
    precision = 0, bbox = structure(c(xmin = -90.5, ymin = 18.3,
                                      xmax = -62.5, ymax = 48.5), class = "bbox"), crs = structure(list(
                                        input = "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_defs",
                                        wkt = "GEOGCRS[\"unknown\",\n    DATUM[\"World Geodetic System 1984\",\n        ELLIPSOID[\"WGS 84\",6378137,298.257223563,\n            LENGTHUNIT[\"metre\",1]],\n        ID[\"EPSG\",6326]],\n    PRIMEM[\"Greenwich\",0,\n        ANGLEUNIT[\"degree\",0.0174532925199433],\n        ID[\"EPSG\",8901]],\n    CS[ellipsoidal,2],\n        AXIS[\"longitude\",east,\n            ORDER[1],\n            ANGLEUNIT[\"degree\",0.0174532925199433,\n                ID[\"EPSG\",9122]]],\n        AXIS[\"latitude\",north,\n            ORDER[2],\n            ANGLEUNIT[\"degree\",0.0174532925199433,\n                ID[\"EPSG\",9122]]]]"), class = "crs"), n_empty = 0L)),
